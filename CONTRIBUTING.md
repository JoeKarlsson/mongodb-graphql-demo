# Contributing to MongoDB GraphQL
...
As for everything else in the project, the contributions to MongoDB Demo are governed by our [Code of Conduct](https://github.com/JoeKarlsson/iot-kitty-litter-box/blob/develop/CODE_OF_CONDUCT.md).

## Using the issue tracker

First things first: **Do NOT report security vulnerabilities in public issues!** Please disclose responsibly by letting [the MongoDB Demo team](mailto:joekarlsson1@gmail.com?subject=Security) know upfront. We will assess the issue as soon as possible on a best-effort basis and will give you an estimate for when we have a fix and release available for an eventual public disclosure.
...
### For Members of the MongoDB Demo Contributors Team
...
Triaging is a great way to contribute to MongoDB Demo without having to write code.
